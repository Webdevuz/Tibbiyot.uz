...
!function(e, t, n) {
    ...
    function f() {
        var e = t.body;
        return e || (e = l(T ? "svg" : "body"),
        e.fake = !0),
        e
    }
    function d(e, n, r, o) {
        var i, a, s, u, c = "modernizr", d = l("div"), p = f();
        if (parseInt(r, 10))
            for (; r--; )
                s = l("div"),
                s.id = o ? o[r] : c + (r + 1),
    ...
    T || !function(e, t) {
        ...
        function u(e) {
            e || (e = t);
            var r = i(e);
            return !A.shivCSS || c || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")),
            f || l(e, r),
            e
        }
    ...
    var O = function() {
        function e(e, t) {
            var o;
            return e ? (t && "string" != typeof t || (t = l(t || "div")),
            e = "on" + e,
            o = e in t,
            !o && r && (t.setAttribute || (t = l("div")),
            t.setAttribute(e, ""),
    ...
    var F = S.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? N(e) : (-1 != e.indexOf("-") && (e = u(e)),
        t ? y(e, t, n) : y(e, "pfx"))
    }
    ;
