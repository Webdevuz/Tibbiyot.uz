...
!function(t, e) {
  ...
  a = 1,
  {
      ...
      T.delete(t, e)
  }, A = Element.prototype.querySelectorAll, S = Element.prototype.querySelector, D = (l = new CustomEvent("Bootstrap",{
      cancelable: !0
  }),
  ...
  var V = {
      ...
      trigger: function(t, e, n) {
          ...
          c && (u.preventDefault(),
          D || Object.defineProperty(u, "defaultPrevented", {
              get: function() {
                  return !0
              }
          })),
    ...
    , z = function() {
      function t(t) {
          this._element = t,
          this._element && k(t, "bs.alert", this)
      }
      var e = t.prototype;
  ...
  V.on(document, "click.bs.carousel.data-api", "[data-slide], [data-slide-to]", lt.dataApiClickHandler),
  ...
  var ht = "collapse"
    ...
    , gt = function() {
      ...
      ,
      e._getConfig = function(t) {
          return (t = s({}, ft, t)).toggle = Boolean(t.toggle),
          v(ht, t, dt),
          t
      }
      ,
    ...
    , wt = function() {
          ...
          if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
              ...
              if (!V.trigger(this._element, "show.bs.dropdown", i).defaultPrevented) {
                  if (!this._inNavbar) {
                      ...
                      var o = this._element;
                      "parent" === this._config.reference ? o = e : m(this._config.reference) && (o = this._config.reference,
      ...
      e.hide = function() {
          if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
              ...
              V.trigger(e, "hide.bs.dropdown", n).defaultPrevented || (this._popper && this._popper.destroy(),
              et.toggleClass(this._menu, "show"),
              et.toggleClass(this._element, "show"),
      ...
      ,
      e._getConfig = function(t) {
          return t = s({}, this.constructor.Default, et.getDataAttributes(this._element), t),
      ...
      t.dataApiKeydownHandler = function(e) {
          if (!(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !vt.test(e.key)) && (e.preventDefault(),
          e.stopPropagation(),
  ...
  V.on(document, "keydown.bs.dropdown.data-api", '[data-toggle="dropdown"]', wt.dataApiKeydownHandler),
  ...
  var kt = {
    ...
    , Ct = function() {
      ...
      e.hide = function(t) {
          ...
          this._isShown && !this._isTransitioning) && !V.trigger(this._element, "hide.bs.modal").defaultPrevented) {
              this._isShown = !1;
      ...
      e._triggerBackdropTransition = function() {
          ...
          if ("static" === this._config.backdrop) {
              ...
              V.one(this._element, "transitionend", (function() {
                  ...
                  e || (V.one(t._element, "transitionend", (function() {
      ...
      for (var o = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(e), r = (i = []).concat.apply(i, o.body.querySelectorAll("*")), a = function(t, n) {
          ...
          l.forEach((function(t) {
              (function(t, e) {
                  ...
                  if (-1 !== e.indexOf(n))
                      return -1 === Dt.indexOf(n) || Boolean(t.nodeValue.match(It) || t.nodeValue.match(Ot));
    ...
    , Ut = function() {
      ...
      e.show = function() {
          ...
          if (this.isWithContent() && this._isEnabled) {
              ...
              if (k(s, this.constructor.DATA_KEY, this),
              ...
              if (this.tip.classList.contains("fade")) {
                  var d = g(this.tip);
                  V.one(this.tip, "transitionend", f),
                  _(this.tip, d)
              } else
                  f()
          }
      ...
      e.setElementContent = function(t, e) {
          if (null !== t)
              ...
              t.appendChild(e)) : t.textContent = e.textContent)) : void (this.config.html ? (this.config.sanitize && (e = jt(e, this.config.allowList, this.config.sanitizeFn)),
  ...
  var ae = {
    ...
    , ce = function() {
      ...
      ,
      e._getConfig = function(t) {
          return t = s({}, le, et.getDataAttributes(this._element), "object" == typeof t && t ? t : {}),
